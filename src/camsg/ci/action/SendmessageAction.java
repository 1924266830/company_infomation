...
/**
 * Servlet implementation class SendmessageAction
 */
...
public class SendmessageAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            e.printStackTrace();
            request.setAttribute("ok","文件发送超出最大值");
        ...
        md.sendMessage(sender, receiver, content,myfilepath);
        
        System.out.println(message);
        request.setAttribute("ok","发送成功");
		Message msg=new Message();
		String pageNow=request.getParameter("m_pageNow");
		System.out.println(myfilepath);
		
		request.getRequestDispatcher("addmessage.jsp?m_pageNow="+pageNow).forward(request, response);
	}
